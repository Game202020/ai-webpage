...
var hobbies = mysqlTable("hobbies", {
  id: int("id").autoincrement().primaryKey(),
...
var analyses = mysqlTable("analyses", {
  ...
  suggestedCourses: text("suggestedCourses"),
  // JSON string
  suggestedJobs: text("suggestedJobs"),
  // JSON string
...
var ownerNotifications = mysqlTable("ownerNotifications", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
...
async function createAnalysis(userId, data) {
  const db = await getDb();
  if (!db) {
...
var appRouter = router({
  ...
  hobby: router({
    analyze: protectedProcedure.input(z2.object({
      hobbiesInput: z2.string().min(10, "\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0648\u0635\u0641 \u0623\u0643\u062B\u0631 \u062A\u0641\u0635\u064A\u0644\u0627\u064B \u0644\u0644\u0647\u0648\u0627\u064A\u0627\u062A")
...
\u0627\u0644\u0645\u0633\u0627\u0631 \u0627\u0644\u0645\u0642\u062A\u0631\u062D: ${analysisData.careerPath}`
    ...
    getHistory: protectedProcedure.query(async ({ ctx }) => {
      try {
        const analyses2 = await getUserAnalyses(ctx.user.id);
        return analyses2.map((analysis) => ({
          ...analysis,
